...
# To export a single parameter: module.exports = existing_nariable_name
# Example:

    var username = "kvasan1604";
    module.exports = username;

# To export mutiple parameters: module.exports = {variable1, variable2...variableN} // will return an object
# Example:

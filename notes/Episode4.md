...
# 1. Common JS Modules [CJS]
    a. By default, common JS module will be enabled and used in node js
    b. In node js, CJS is the prefered way to import/export the modules
    c. Oldest way of import/export
    d. Synchronous
    e. Runs on non-strict mode
...
# Advantages:
    ...
    b. Protects your variables/functions

# 5. ES6 Imports/Exports 
    a. Newest way of import/export
    b. To enable ES6 imports/exports, add the following in the package.json file:
        {
            "type": "module"
        }
    c. Asynchronous
    d. Runs on strict mode
